...
/**
 * 检查回环关键帧
 * @brief 通过查找共享单词并计算相似度得分来检测可能的回环候选关键帧。
 * @param pKF The keyframe for which we want to detect loop candidates
 * @param minScore The minimum score for a loop candidate
 * @return A vector of loop candidates
 */
