...
void Optimizer::BundleAdjustment(const vector<KeyFrame *> &vpKFs,
  ...
  //     unique_ptr<g2o::BlockSolver_6_3::LinearSolverType>(linearSolver));?lin?

  // g2o::OptimizationAlgorithmLevenberg *solver =
  //     new g2o::OptimizationAlgorithmLevenberg(
  //         unique_ptr<g2o::BlockSolver_6_3>(solver_ptr));
...
void Optimizer::FullInertialBA(Map *pMap, int its, const bool bFixLocal,
  ...
  // g2o::OptimizationAlgorithmLevenberg *solver =
  //     new g2o::OptimizationAlgorithmLevenberg(
  //         unique_ptr<g2o::BlockSolverX>(solver_ptr));
...
void Optimizer::OptimizeEssentialGraph(
  ...
  // g2o::OptimizationAlgorithmLevenberg *solver =
  //     new g2o::OptimizationAlgorithmLevenberg(
  //         unique_ptr<g2o::BlockSolver_7_3>(solver_ptr));
