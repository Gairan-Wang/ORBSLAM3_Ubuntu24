...
Tracking::Tracking(System *pSys, ORBVocabulary *pVoc, FrameDrawer *pFrameDrawer,
    ...
    : mState(NO_IMAGES_YET), mSensor(sensor), mTrackedFr(0), mbStep(false),
      ...
      mpSystem(pSys), mpViewer(NULL), mpFrameDrawer(pFrameDrawer),
      mpMapDrawer(pMapDrawer), bStepByStep(false), mpAtlas(pAtlas),
      mpLastKeyFrame(static_cast<KeyFrame *>(NULL)), mnLastRelocFrameId(0),
      time_recently_lost(5.0), mnFirstFrameId(0), mnInitialFrameId(0),
      mbCreatedMap(false), mpCamera2(nullptr) {
